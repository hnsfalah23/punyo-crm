<div class="container-fluid px-4">
  <div data-aos="fade-up">
    <h1 class="mt-4">Tambah Instansi Baru</h1>
  ...
  <div class="card mb-4" data-aos="fade-up" data-aos-delay="200">
    <div class="card-header">
      <i class="bi bi-building-fill-add me-1"></i>
      Formulir Instansi Baru
    </div>
    <div class="card-body">
      <form action="<?= BASE_URL; ?>/instansi/add" method="POST">
        ...
        <div class="d-flex justify-content-end mt-3">
          ...
          <button type="submit" class="btn btn-primary"><i class="bi bi-save me-2"></i>Simpan Instansi</button>
        </div>
      </form>
    </div>
  </div>
