<div class="container-fluid px-4">
  <div data-aos="fade-up">
    <h1 class="mt-4">Tambah Prospek Baru</h1>
  ...
  <div class="card mb-4" data-aos="fade-up" data-aos-delay="200">
    <div class="card-header">
      ...
      Formulir Prospek Baru
    </div>
    <div class="card-body">
      <form action="<?= BASE_URL; ?>/leads/add" method="POST">
        <div class="row gx-4">
          <div class="col-lg-6">
        ...
        <div class="d-flex justify-content-end mt-3">
          ...
          <button type="submit" class="btn btn-primary"><i class="bi bi-save me-2"></i>Simpan Prospek</button>
        </div>
      </form>
    </div>
  </div>
