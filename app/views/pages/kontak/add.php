<!-- app/views/pages/kontak/add.php -->
<div class="container-fluid px-4">
  <h1 class="mt-4">Tambah Kontak untuk <?= htmlspecialchars($data['instansi']->name); ?></h1>
  ...
  <div class="card mb-4">
    <div class="card-header">
      <p>Form Tambah Kontak</p>
    </div>
    <div class="card-body">
      <form action="<?= BASE_URL; ?>/kontak/add/<?= $data['instansi']->company_id; ?>" method="POST">
        <div class="row">
